...
import com.furkanaskin.app.podpocket.db.dao.EpisodesDao
...
@Database(entities = [Example::class, UserEntity::class, PlayerEntity::class, EpisodeEntity::class], version = 1)
