...
data class Regions(
    ...
    @field:SerializedName("hk")
    val hk: String? = null,

    @field:SerializedName("pt")
    val pt: String? = null,

    @field:SerializedName("hn")
    val hn: String? = null,

    @field:SerializedName("pw")
    val pw: String? = null,

    @field:SerializedName("py")
    val py: String? = null,

    @field:SerializedName("hr")
    val hr: String? = null,

    @field:SerializedName("ye")
    val ye: String? = null,
    ...
    @field:SerializedName("il")
    val il: String? = null,

    @field:SerializedName("ae")
    val ae: String? = null,

    @field:SerializedName("in")
    val inn: String? = null,

    @field:SerializedName("ag")
    val ag: String? = null,

    @field:SerializedName("za")
    val za: String? = null,
    ...
    @field:SerializedName("au")
    val au: String? = null,

    @field:SerializedName("az")
    val az: String? = null,

    @field:SerializedName("zw")
    val zw: String? = null,
    ...
    @field:SerializedName("tj")
    val tj: String? = null,

    @field:SerializedName("cz")
    val cz: String? = null,

    @field:SerializedName("lc")
    val lc: String? = null,

    @field:SerializedName("tm")
    val tm: String? = null,
    ...
    @field:SerializedName("dk")
    val dk: String? = null,

    @field:SerializedName("lt")
    val lt: String? = null,

    @field:SerializedName("lu")
    val lu: String? = null,

    @field:SerializedName("dm")
    val dm: String? = null,
    ...
    @field:SerializedName("eg")
    val eg: String? = null,

    @field:SerializedName("mo")
    val mo: String? = null,

    @field:SerializedName("uy")
    val uy: String? = null,
    ...
    @field:SerializedName("mu")
    val mu: String? = null,

    @field:SerializedName("mw")
    val mw: String? = null,
    ...
    @field:SerializedName("vn")
    val vn: String? = null,

    @field:SerializedName("ng")
    val ng: String? = null,

    @field:SerializedName("ni")
    val ni: String? = null,
    ...
    @field:SerializedName("gh")
    val gh: String? = null,

    @field:SerializedName("gm")
    val gm: String? = null,

    @field:SerializedName("gr")
    val gr: String? = null,

    @field:SerializedName("gt")
    val gt: String? = null,

    @field:SerializedName("gw")
    val gw: String? = null,
    ...
    @field:SerializedName("pe")
    val pe: String? = null,

    @field:SerializedName("pg")
    val pg: String? = null,
