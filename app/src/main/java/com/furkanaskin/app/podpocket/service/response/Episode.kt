...
data class Episode(
    ...
    fun getTotalEpisodes(): String? = "${podcast?.totalEpisodes} Bölüm"

    fun getPodcastLanguage(): String? = "Yayın Dili : ${podcast?.language}"

    fun getPodcast(): String? = "Podcast : ${podcast?.title}"
